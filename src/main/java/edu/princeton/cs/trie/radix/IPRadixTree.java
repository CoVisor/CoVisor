 ...
 */
public interface IPRadixTree<O> {
    ...
    //List<CharSequence> getPrefixKeysStartingWith(CharSequence prefix);
    ...
    //List<O> getValuesForPrefixKeysStartingWith(CharSequence prefix);
    ...
    List<KeyValuePair<O>> getIPKeyValuePairsForKeysStartingWith(CharSequence prefix);
